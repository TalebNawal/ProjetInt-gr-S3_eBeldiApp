...
class TopCategoriesInv extends StatelessWidget {
  const TopCategoriesInv({Key? key}) : super(key: key);

  void navigateToCategoryPage(BuildContext context, String category) {
    Navigator.pushNamed(context, CategoryDealsScreenInv.routeName,
        arguments: category);
  }
